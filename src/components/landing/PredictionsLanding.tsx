...
const PREDICTIONS_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "The daily personalized horoscope is a Premium feature of AstroTarot Hub. New accounts start with 4 free tarot readings. Unlimited Premium ($14.99/month) unlocks the daily horoscope along with numerology, birth chart, fortune and soulmate compatibility readings.",
  },
  {
