...
const COMPATIBILITY_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "The compatibility (soulmate) reading is part of the Unlimited Premium plan ($14.99/month), which also includes daily horoscopes, numerology, birth charts and fortune readings. New accounts start with 4 free tarot readings so you can try the platform first — no credit card required.",
  },
];
