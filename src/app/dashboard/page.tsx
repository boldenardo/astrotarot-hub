...
import { trackPageView, trackSubscriptionUpgradeClicked } from "@/lib/analytics";
...
const zodiacSigns: Record<string, ZodiacSign> = {
  aries: {
    ...
    ruler: "Marte",
    dates: "21/03 - 19/04",
    traits: ["Corajoso", "Determinado", "Líder natural", "Impulsivo", "Energético"],
...
export default function DashboardPage() {
  ...
  const birthChart = user?.birth_date
    ? {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  {isPremium
                    ...
                    : `${user?.readings_left || 0} leituras gratuitas restantes`}
                </p>
              </div>
            </div>
            {isFree && (
              <Link
                href="/cart"
                onClick={() => trackSubscriptionUpgradeClicked("premium_monthly")}
        ...
        {birthChart && (
          <motion.div
            ...
            className={`p-8 rounded-3xl bg-gradient-to-br ${birthChart.sign.color} mb-8 relative overflow-hidden`}
          >
            <div className="absolute top-0 right-0 text-[200px] opacity-10 leading-none">
              {birthChart.sign.symbol}
            </div>
            <div className="relative z-10">
              <p className="text-white/80 text-sm font-semibold mb-2">SEU SIGNO SOLAR</p>
              <h3 className="text-5xl font-bold text-white mb-2">
                {birthChart.sign.symbol} {birthChart.sign.name}
              </h3>
              <p className="text-white/90 mb-4">{birthChart.sign.dates}</p>
              <div className="flex flex-wrap gap-2">
                {birthChart.sign.traits.map((trait) => (
                  <span
                    key={trait}
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-3">Tire suas 4 cartas místicas</p>
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-3">Leitura completa com IA</p>
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-3">Análise astrológica amorosa</p>
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-3">Seu futuro nas estrelas</p>
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-3">Rituais de prosperidade</p>
        ...
        >
          <h2 className="text-2xl font-bold mb-4">📜 Minhas Últimas Leituras</h2>
          {readings.length === 0 ? (
            <div className="p-8 bg-gray-900/50 border border-gray-700 rounded-2xl text-center">
              <Calendar className="w-16 h-16 text-gray-600 mx-auto mb-4" />
              <p className="text-gray-400 mb-4">Você ainda não realizou nenhuma leitura</p>
              <Link
                href="/challenge"
            ...
            <div className="space-y-4">
              {readings.map((reading) => (
                ...
                >
                  ...
                  <p className="text-gray-300 line-clamp-2">{reading.interpretation}</p>
                </div>
              ))}
            </div>
          )}
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-6">
                Por apenas <span className="text-yellow-400 font-bold">R$ 29,90/mês</span>
              </p>
              <Link
                href="/cart"
                onClick={() => trackSubscriptionUpgradeClicked("premium_monthly")}
