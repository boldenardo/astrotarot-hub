...
export const HOME_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. You get 4 free tarot readings, Egyptian Tarot insights and access to the Spiritual Guide without a credit card. A 5-Reading Pack ($9.99 one-time) and an Unlimited Premium plan ($9.99/month) unlock more readings and premium features.",
  },
  {
