...
export const HOME_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. You get 4 free tarot readings, Egyptian Tarot insights and access to the Spiritual Guide without a credit card. An Unlimited Premium plan ($9.99/month) unlocks more readings and premium features.",
  },
  {
